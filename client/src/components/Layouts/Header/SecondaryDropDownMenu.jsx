  ...
  const navs = [
    {
      ...
      redirect: 'https://www.Holy Tradres.com/communication-preferences/push',
    },
    {
      title: 'Sell on Holy Tradres',
      icon: <BusinessCenterIcon sx={{ fontSize: '18px' }} />,
      redirect: 'https://seller.Holy Tradres.com/sell-online',
    },
    {
    ...
    },
    {
      ...
      redirect: 'https://advertising.Holy Tradres.com',
    },
    {
      title: 'Download App',
      icon: <DownloadIcon sx={{ fontSize: '18px' }} />,
      redirect: 'https://www.Holy Tradres.com/mobile-apps',
    },
  ];
