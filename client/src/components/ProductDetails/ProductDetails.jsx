                  ...
                  <div className='w-full flex gap-3'>
                    ...
                    {product.stock > 0 && (
                      <button
                        ...
                        className='p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-yellow rounded-sm shadow hover:shadow-lg disabled:cursor-not-allowed'
                        disabled
                      >
                        <ShoppingCartIcon />
                    ...
                    <button
                      ...
                      className={
                        product.stock < 1
                          ...
                          : 'p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-orange rounded-sm shadow hover:shadow-lg disabled:cursor-not-allowed'
                      }
                    >
                      <FlashOnIcon />
                  ...
                  {Array(3)
                    ...
                    .map((el, i) => (
                      <p className='text-sm flex items-center gap-1' key={i}>
                        ...
                        Instant discount on first Holy Tradres Pay Later order
                        of 500 and above{' '}
